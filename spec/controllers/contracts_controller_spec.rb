  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contract as @contract" do
        ...
        post :create, {:contract => { "title" => "invalid value" }}, valid_session
        assigns(:contract).should be_a_new(Contract)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contract" do
        ...
        Contract.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => contract.to_param, :contract => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contract as @contract" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contract.any_instance.stub(:save).and_return(false)
        put :update, {:id => contract.to_param, :contract => { "title" => "invalid value" }}, valid_session
        assigns(:contract).should eq(contract)
      end
